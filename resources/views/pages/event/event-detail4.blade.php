...
<html data-theme="light" lang="id">
  ...
  <body class="font-popins">
    ...
    <section
      id="about"
      class="bg-cover bg-center relative w-full h-[1000px] mt-20" 
      style="background-image: url('/assets/bg-thespeaker.svg');">
<!-- div 1   -->
  <div class="flex items-center justify-center gap-20">
    <span class="flex items-center mt-36">
      <img src="/assets/event4-speaker1.svg" alt="" class="w-[304px] h-[400px]" />
      <span class="relative bg-white py-8 px-5 text-center rounded-xl ml-[-32px]">
        <div class="absolute top-0 left-0 w-full h-3 bg-hijau rounded-full"></div>
        <h1 class="font-poppins text-[27px] font-semibold ">Phan Hoang Lan</h1>
        <p class="font-poppins text-[17px] font-normal w-[290px] h-[50px] text-black">Head Of The Center For Enterpreneurship And Innovation (CEI), Fulbright University Vietnam </p>
      </span>
    </span>

    <span class="flex items-center mt-36">
      <img src="/assets/event4-speaker2.svg" alt="" class="w-[304px] h-[400px]" />
      <span class="relative bg-white py-2 px-10 text-center rounded-xl ml-[-32px]">
        <div class="absolute top-0 left-0 w-full h-3 bg-hijau rounded-full"></div>
        <h1 class="font-poppins text-[27px] font-semibold mt-5">Steve Loh</h1>
        <p class="font-poppins text-[17px] font-normal w-[290px] h-[50px] text-black">Executive Director, SMU Lion Center For social Innovation</p>
      </span>
    </span>
  </div>
  
  <div class="flex items-center justify-center gap-20">
    <span class="flex items-center mt-[-100px]">
      <img src="/assets/event4-speaker3.svg" alt="" class="w-[304px] h-[400px]" />
      <span class="relative bg-white py-2 px-10 text-center rounded-xl ml-[-32px]">
        <div class="absolute top-0 left-0 w-full h-3 bg-hijau rounded-full"></div>
        <h1 class="font-poppins text-[27px] font-semibold mt-8">Dorothy Ching</h1>
        <p class="font-poppins text-[17px] font-normal w-[290px] h-[50px] text-black">Executive Director, TBN Asia</p>
      </span>
    </span>

    <span class="flex items-center  mt-[-100px]">
      <img src="/assets/event4-speaker4.svg" alt="" class="w-[304px] h-[400px]" />
      <span class="relative bg-white py-7 px-10 text-center rounded-xl ml-[-32px]">
        <div class="absolute top-0 left-0 w-full h-3 bg-hijau rounded-full"></div>
        <h1 class="font-poppins text-[27px] font-semibold ">DR Josh Yates</h1>
        <p class="font-poppins text-[17px] font-normal w-[290px] h-[50px] text-black">Execvutive Director, Belmont Innovation Hub, Belmont University, Nashville </p>
      </span>
    </span>
  </div>
</section>
