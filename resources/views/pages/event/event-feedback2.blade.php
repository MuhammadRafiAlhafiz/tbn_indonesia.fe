...
<body class="font-popins">
  ...
  <section id="Payment-section">
    <div class="flex flex-col justify-center items-center">
      <img class="w-[500px] h-[750px]" src="/assets/banner-event2.svg" alt="" />
      <span class="w-[1000px]">
        <a href="{{ route('event') }}">
          <p class="text-hijau font-nunito text-[20px] font-normal">[ About Conference ]</p>
        </a>
        <h1 class="font-popins text-[34px] font-semibold py-2">TBN Asia Conference 2023</h1>
  ...
  <section>
    ...
    <div class="mt-10 mx-28">
      <div class="flex gap-5">
        <img class="w-[43px] h-[43px]" src="/assets/event-feedbackcostumer1.svg" alt="Feedback Customer 1" />
        <div class="flex-col mt-2">
          ...
          <p class="w-[570px] h-[60px] text-[17px] font-normal py-2">
            This conference opened my eyes to the latest sales strategies and provided a lot of practical insights. The networking opportunities were invaluable. Truly inspiring!
          </p>
          <p class="text-[14px] mt-10 font-bold">Kristin Watson</p>
          <p class="text-[13px] font-normal text-gray-700">Desember 14, 2023</p>
        </div>
      </div>
      <hr class="w-[700px] border-t-3 border-gray-300 mt-2" />

      <div class="flex gap-5 mt-5">
        <img class="w-[43px] h-[43px]" src="/assets/event-feedbackcostumer2.svg" alt="Feedback Customer 2" />
        <div class="flex-col mt-2">
          <div class="flex w-[23px] h-[23px]">
            <img src="/assets/event-feedbackstar.svg" alt="Star" />
            <img src="/assets/event-feedbackstar.svg" alt="Star" />
          ...
          <p class="w-[570px] h-[60px] text-[17px] font-normal py-2">
            The sessions were packed with valuable and relevant information. I learned a lot about using technology and building better customer relationships. The atmosphere was very supportive!
          </p>
          <p class="text-[14px] font-bold">Jenny Wilson</p>
          <p class="text-[13px] font-normal text-gray-700">January 28, 2024</p>
        </div>
      </div>
      <hr class="w-[700px] border-t-3 border-gray-300 mt-2" />

      <div class="flex gap-5 mt-5">
        <img class="w-[43px] h-[43px]" src="/assets/event-feedbackcostumer3.svg" alt="Feedback Customer 3" />
        <div class="flex-col mt-2">
          <div class="flex w-[23px] h-[23px]">
            <img src="/assets/event-feedbackstar.svg" alt="Star" />
            <img src="/assets/event-feedbackstar.svg" alt="Star" />
          ...
          <p class="w-[570px] h-[60px] text-[17px] font-normal py-2">
            The Transformational Sales Conference 2023 provided practical tools and creative ideas to enhance my sales skills. It was incredibly helpful to see sales from a different perspective. Highly recommended!
          </p>
          <p class="text-[14px] mt-10 font-bold">Bessie Cooper</p>
          <p class="text-[13px] font-normal text-gray-700">January 11, 2024</p>
        </div>
      </div>
      <hr class="w-[700px] border-t-3 border-gray-300 mt-2" />
  ...
  <!-- FEEDBACK FORM -->
  <section id="feedbackSection" class="flex justify-center mt-20">
    <div class="bg-white p-8 rounded-lg w-full max-w-md">
      <div class="flex flex-col items-center">
        <div class="bg-hijau w-[130px] h-[14px] rounded-lg mb-4"></div>
        <h1 class="font-popins text-[56px] font-bold text-blue-950 mb-2 w-[610px] h-[67px]">
          Share Your Feedback
        </h1>
      ...
      <form>
        ...
        <div class="mb-4">
          <textarea placeholder="Your message..." class="w-full p-3 border rounded-lg"></textarea>
        </div>
        <div class="mb-6 flex items-center justify-center">
          <button type="button" class="flex items-center py-2 px-20 border-2 rounded-2xl text-gray-600 focus:outline-none">
            <img src="/assets/event-cameraphoto.svg" alt="Add Photo" />
            Add Photo
          </button>
        </div>
        <div class="flex justify-center">
          <button id="submitButton" class="bg-hijau text-white rounded-full px-6 py-3 w-[610px] font-semibold hover:bg-gray-300">
            Submit
          </button>
        </div>
      </form>
  ...
  <section id="thankYouSection" class="hidden flex-col">
    <div class="text-center flex justify-center items-center mt-20">
      <div>
        <img src="/assets/event-payment-sucsses payment.svg" alt="Check Mark" class="w-[300px] h-[350px]" />
      </div>
      <div>
        <h1 class="text-[34px] font-semibold font-popins text-hijau">THANK YOU for Feedback!</h1>
        <p class="mt-2 text-[34px] font-semibold">
          We hope you enjoyed this event and hope to see you at the next event.
        </p>
        <a href="{{ route('event') }}">
          <button class="mt-6 bg-hijau text-white px-20 py-2 rounded-full">Done</button>
        </a>
      </div>
    </div>
  </section>
  ...
  <section id="footerSection" class="bg-white mt-10">
    <div class="flex flex-col md:flex-row md:p-10 justify-between mx-10">
      ...
      <div class="flex flex-col mt-5">
        <h1 class="text-[21px] md:text-lg font-semibold font-popins">LOKASI</h1>
        <p class="text-[18px] md:text-base font-normal font-popins mt-3 md:mt-5">Jl. M.H.Thamrin No.20, Menteng</p>
        <p class="text-[18px] md:text-base font-normal font-popins">Jakarta Pusat 10350, Indonesia</p>
      </div>
      <div>
        <h1 class="font-popins font font-semibold text-[21px] md:text-lg mt-2">Perusahaan</h1>
      ...
      <div>
        <h1 class="font-popins font-semibold text-[21px] md:text-lg">Ikuti Social Media Kami</h1>
        <div class="flex gap-3 md:gap-[20px] py-5">
          ...
          <a href="https://wa.me/+6282310001908">
            <img src="/assets/nav-whatsapp.svg" alt="" />
          </a>
          <a href="">
            <img src="/assets/nav-gmail.svg" alt="" />
          </a>
          <a href="">
            <img src="/assets/nav-link.svg" alt="" />
          </a>
        </div>
        <h1 class="font-popins font-semibold text-[21px] md:text-lg">Hubungi Kami</h1>
