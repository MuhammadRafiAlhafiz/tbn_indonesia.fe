...
<!-- div 1   -->
  <div class="flex items-center justify-center gap-20">
    <span class="flex items-center mt-36">
      <img src="/assets/event3-speaker1.svg" alt="" class="w-[304px] h-[400px]" />
      <span class="relative bg-white px-10 text-center rounded-xl ml-[-32px]">
        ...
        <h1 class="font-poppins text-[27px] font-semibold mt-10">Lim Fang Wei</h1>
        <p class="font-poppins text-[17px] font-normal w-[290px] h-[50px] text-black">Invesment Manager</p>
      </span>
    </span>

    <span class="flex items-center mt-36">
      <img src="/assets/event3-speaker2.svg" alt="" class="w-[304px] h-[400px]" />
      <span class="relative bg-white py-2 px-10 text-center rounded-xl ml-[-32px]">
        <div class="absolute top-0 left-0 w-full h-3 bg-hijau rounded-full"></div>
        <h1 class="font-poppins text-[27px] font-semibold mt-10">Leon Toh</h1>
        <p class="font-poppins text-[17px] font-normal w-[290px] h-[50px] text-black">Managing Patner,Damson Capital</p>
      </span>
    </span>
  </div>
  ...
  <div class="flex items-center justify-center gap-20">
    <span class="flex items-center mt-[-100px]">
      <img src="/assets/event3-speaker3.svg" alt="" class="w-[304px] h-[400px]" />
      <span class="relative bg-white py-2 px-10 text-center rounded-xl ml-[-32px]">
        <div class="absolute top-0 left-0 w-full h-3 bg-hijau rounded-full"></div>
        <h1 class="font-poppins text-[27px] font-semibold mt-8">Dikson Lim</h1>
        <p class="font-poppins text-[17px] font-normal w-[290px] h-[50px] text-black">Head of Philantrophy and Community Impact</p>
      </span>
    </span>

    <span class="flex items-center  mt-[-100px]">
      <img src="/assets/event3-speaker4.svg" alt="" class="w-[304px] h-[400px]" />
      <span class="relative bg-white py-2 px-10 text-center rounded-xl ml-[-32px]">
        <div class="absolute top-0 left-0 w-full h-3 bg-hijau rounded-full"></div>
        <h1 class="font-poppins text-[27px] font-semibold mt-5">Romy Cahyadi</h1>
        <p class="font-poppins text-[17px] font-normal w-[290px] h-[50px] text-black">Chairperson,Indonesia Impact Alliance</p>
      </span>
    </span>
  </div>
</section>
