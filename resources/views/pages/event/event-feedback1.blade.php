...
<body class="font-popins">
  ...
  <section id="Payment-section">
    <div class="flex flex-col justify-center items-center mt-10">
      <img class="w-[500px] h-[750px]" src="/assets/banner-event1.svg" alt="Banner Event 1" />
  ...
  <section id="feedbackFormSection" class="flex justify-center mt-20">
    <div class="bg-white p-8 rounded-lg w-full max-w-md">
      <div class="flex flex-col items-center">
        ...
        <h1 class="font-popins text-[56px] font-bold text-blue-950 mb-2 w-[610px] h-[67px]">Share Your Feedback</h1>
