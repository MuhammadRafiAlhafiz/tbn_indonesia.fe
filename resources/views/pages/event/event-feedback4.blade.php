...
<body class="font-poppins">
  ...
  <section id="Payment-section">
    <div class="flex flex-col justify-center items-center mt-10">
      <img class="w-[500px] h-[750px]" src="/assets/banner-event4.svg" alt="" />
      <span class="w-[1000px] mt-10">
        ...
        <div class="w-[967px] h-[250px] font-poppins text-[21px] font-semibold">
          ...
          <p class="py-5">
            It's crucial to adapt to the changing sales landscape in the digital age, and Seth Godin's quote emphasizes the importance of customer-centricity. Digital transformation has indeed shifted the focus towards online sales, but it's essential to remember that serving the customer's needs remains paramount.
          </p>
          <span>
  ...
  <section class="flex justify-center mt-20">
    <div class="bg-white p-8 rounded-lg w-full max-w-md">
      <div class="flex flex-col items-center">
        ...
        <h1 class="font-poppins text-[56px] font-bold text-blue-950 mb-2 w-[610px] h-[67px]">
          Share Your Feedback
        </h1>
  ...
  <footer class="bg-white mt-10">
    <div class="flex flex-col md:flex-row md:p-10 justify-between mx-10">
      ...
      <div class="flex flex-col mt-5">
        <h1 class="text-[21px] md:text-lg font-semibold font-poppins">LOKASI</h1>
        <p class="text-[18px] md:text-base font-normal font-poppins mt-3 md:mt-5">
          Jl. M.H.Thamrin No.20, Menteng
        </p>
        <p class="text-[18px] md:text-base font-normal font-poppins">Jakarta Pusat 10350, Indonesia</p>
      </div>

      <div>
        <h1 class="font-poppins font font-semibold text-[21px] md:text-lg mt-2">Perusahaan</h1>
      ...
      <div>
        <h1 class="font-poppins font-semibold text-[21px] md:text-lg">Ikuti Social Media Kami</h1>
        ...
        <h1 class="font-poppins font-semibold text-[21px] md:text-lg">Hubungi Kami</h1>
        <div class="flex gap-1 mt-2">
          <img src="/assets/icon email.svg" class="font-poppins font-normal text-[17px]" alt="" />
